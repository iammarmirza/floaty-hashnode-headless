...
export const Blogs = () => {
    ...
    return(
        <div className="bg-white w-full shadow-lg rounded-3xl p-6 flex flex-col items-start">
            <div className="w-full flex flex-row justify-between items-center mb-6">
                <h2 className="text-2xl font-semibold text-slate-800">Blogs</h2>
                <Link
                    href={'/blog'}
                    className="hidden md:flex flex-row items-center gap-2 rounded-full text-sm px-3 py-1 hover:bg-slate-600 hover:text-white hover:gap-3">
