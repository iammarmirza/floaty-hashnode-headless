...
export async function generateMetadata(
  ...
  return {
    ...
    description: data?.publication?.descriptionSEO || `${data?.publication?.author.name}'s Blog`,
    twitter: {
      card: "summary_large_image",
      title: data?.publication?.displayTitle || data?.publication?.title || 'Hashnode Blog Starter Kit',
      description: data?.publication?.descriptionSEO || data?.publication?.title || `${data?.publication?.author.name}'s Blog`,
      images: [
        {
          url:
